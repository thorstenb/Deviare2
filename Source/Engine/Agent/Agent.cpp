...
#include "DetectApp.h"
  ...
  //#define ATTACH_2_DEBUGGER_AT_STARTUP
    ...
    #pragma comment(lib, "..\\..\\..\\Externals\\DeviareInProc\\Libs\\" X_LIBPATH "\\NktHookLib_Debug.lib")
#else //_DEBUG
    #pragma comment(lib, "..\\..\\..\\Libs\\Lz4Lib.lib")
    #pragma comment(lib, "..\\..\\..\\Externals\\DeviareInProc\\Libs\\" X_LIBPATH "\\NktHookLib.lib")
  #endif //_DEBUG
#elif defined _M_X64
  #ifdef _DEBUG
    #pragma comment(lib, "..\\..\\..\\Libs\\Lz4Lib64_Debug.lib")
    #pragma comment(lib, "..\\..\\..\\Externals\\DeviareInProc\\Libs\\" X_LIBPATH "\\NktHookLib64_Debug.lib")
  #else //_DEBUG
    #pragma comment(lib, "..\\..\\..\\Libs\\Lz4Lib64.lib")
    #pragma comment(lib, "..\\..\\..\\Externals\\DeviareInProc\\Libs\\" X_LIBPATH "\\NktHookLib64.lib")
  #endif //_DEBUG
#else
